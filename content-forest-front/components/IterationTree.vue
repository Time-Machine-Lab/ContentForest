...
const nodes: N[] = [
  { id:'seed',  label:'SEED',    metric:'AI�����ƹ�',   x:70,  y:170, r:14, color:'#f59e0b', fill:'rgba(245,158,11,0.18)', glow:'amber', fs:9,  delay:0,    pulsing:true,  parent:undefined, tip:[{k:'type',v:'Origin Seed',c:'text-mutation'}] },
  { id:'fA',    label:'Fruit A', metric:'1,247 likes',  x:230, y:85,  r:10, color:'#00ff9f', fill:'rgba(0,255,159,0.14)',  glow:'green', fs:9,  delay:600,  pulsing:true,  parent:'seed',    tip:[{k:'platform',v:'С����',c:'text-slate-300'},{k:'likes',v:'1,247',c:'text-bio-green'}] },
  ...
  { id:'fC',    label:'Fruit C', metric:'580 fav',       x:230, y:290, r:10, color:'#00ff9f', fill:'rgba(0,255,159,0.14)',  glow:'green', fs:9,  delay:800,  pulsing:true,  parent:'seed',    tip:[{k:'platform',v:'֪������',c:'text-slate-300'},{k:'favorites',v:'580',c:'text-bio-green'}] },
  { id:'fA1',   label:'A1',      metric:'2,100 likes',  x:400, y:35,  r:7,  color:'#00ff9f', fill:'rgba(0,255,159,0.10)',  glow:'green', fs:8,  delay:1300, parent:'fA',      tip:[{k:'type',v:'�Ż�����',c:'text-slate-300'},{k:'likes',v:'2,100',c:'text-bio-green'}] },
  { id:'fA2',   label:'A2',      metric:'85K views',    x:400, y:110, r:9,  color:'#0ea5e9', fill:'rgba(14,165,233,0.14)', glow:'blue',  fs:8,  delay:1450, parent:'fA',      tip:[{k:'platform',v:'����',c:'text-slate-300'},{k:'views',v:'85,000',c:'text-gene-blue'}] },
  ...
  { id:'fA2a',  label:'A2a hot', metric:'210K views',   x:590, y:75,  r:12, color:'#0ea5e9', fill:'rgba(14,165,233,0.22)', glow:'blue',  fs:8,  delay:2200, pulsing:true,  parent:'fA2',     tip:[{k:'type',v:'��������',c:'text-slate-300'},{k:'views',v:'210,000',c:'text-gene-blue'}] },
  ...
  { id:'fC1',   label:'C1',      metric:'������',         x:400, y:290, r:7,  color:'#00ff9f', fill:'rgba(0,255,159,0.08)',  glow:'green', fs:8,  delay:1900, parent:'fC',      tip:[{k:'type',v:'������',c:'text-slate-300'},{k:'status',v:'������',c:'text-mutation'}] },
]
