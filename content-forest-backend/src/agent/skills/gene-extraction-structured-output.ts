    ...
    messages: [
      {
        ...
        content: [
          ...
          "A gene is a testable content expression hypothesis, not a generic label.",
          "Return exactly one JSON object and no prose.",
          "The JSON shape must be: {\"type\":\"gene_extraction_suggestions\",\"suggestions\":[{\"title\":\"...\",\"bodyMarkdown\":\"...\",\"polarity\":\"positive|negative\",\"evidenceInterpretation\":\"...\",\"nextRoundUsage\":\"...\",\"lineage\":\"...\",\"niche\":\"...\",\"similarityRelation\":\"new|reinforces|branches|conflicts\",\"relatedInsightIds\":[],\"warnings\":[]}]}",
          "Return 1 to 3 suggestions.",
          "Positive genes describe traits worth preserving, strengthening, combining, or mutating.",
          "Negative genes describe traits to avoid, suppress, or use only within a narrow boundary.",
          "bodyMarkdown must include: the expression trait, applicable niche, and next-round usage advice.",
          "nextRoundUsage must be a concise actionable instruction for the next round.",
          "The next-round usage advice must say how branch growth should inherit, strengthen, mutate, combine, or avoid the trait.",
          "evidenceInterpretation must explain evidence strength. Human selection is weak evidence unless platform feedback is present.",
          "Do not invent metrics or platform feedback that are not present in the authorized context.",
