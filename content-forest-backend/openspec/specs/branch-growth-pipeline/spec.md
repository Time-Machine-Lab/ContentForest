...
Defines the backend pipeline that prepares branch growth context, search radius controls, mutation planning, and user-visible generation paths before and during Agent execution.
