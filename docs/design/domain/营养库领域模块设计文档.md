...
- **包含**：创建营养库，区分公共营养库与种子专属营养库，上传营养内容，编辑营养内容，归档营养内容，回档营养内容，查看营养库与营养内容，维护种子级营养卡片生命周期，设置常驻营养，绑定营养卡片研究会话，并为枝化生长提供可引用或临时引用的营养资料。
...
- **营养卡片 (Nutrient Card)**：归属于某个种子的候选资料单元，用于承接用户投喂、Agent 研究或缺口提醒产生的资料。营养卡片的正文仍是 Markdown，系统事实由数据库维护。
- **未沉淀营养卡片 (Unsettled Nutrient Card)**：仍在研究、整理或验证中的营养卡片，可以作为本次枝化生长的临时引用，但不是正式营养内容。
- **已沉淀营养卡片 (Settled Nutrient Card)**：已经被用户确认并写入当前种子专属营养库的营养卡片。它保留与正式营养内容的关联。
- **已归档营养卡片 (Archived Nutrient Card)**：保留历史但不可引用的营养卡片。
- **常驻营养 (Default For Growth)**：已沉淀营养卡片上的默认带入标记。它表示工作区在每次枝化生长前默认选中该营养，但用户可以移除；它不是后端强制引用规则。
- **营养卡片会话 (Nutrient Card Conversation)**：营养卡片与研究对话之间的绑定关系，用于让用户围绕同一张卡片持续追问、补充和优化资料。
...
营养卡片不是公共营养库的一部分，它始终归属于一个具体种子。未沉淀卡片用于快速承接候选资料和研究过程；沉淀后，系统将其写入当前种子专属营养库中的正式营养内容，并保留卡片与正式营养内容之间的关联。这样既能让资料在验证前被临时使用，又能避免 Agent 研究结果直接污染正式营养库。
...
- **卡片种子归属约束**：营养卡片必须归属于一个明确种子，不允许保存到公共营养库。
- **卡片状态约束**：营养卡片只允许处于未沉淀、已沉淀、已归档三类状态。
- **未沉淀临时引用约束**：未沉淀营养卡片可以作为当前种子本次枝化生长的临时资料引用，但不能伪装成正式营养内容。
- **沉淀约束**：未沉淀营养卡片沉淀时，只能写入当前种子的种子专属营养库，并必须保留与正式营养内容的关联。
- **已归档卡片不可引用约束**：已归档营养卡片不可作为临时引用，也不可通过已沉淀关联进入可引用营养范围。
- **常驻营养约束**：只有已沉淀营养卡片可以设置为常驻营养；常驻营养只影响前端默认带入，不代表后端强制引用。
- **会话绑定约束**：营养卡片可以绑定一个研究会话标识，但具体 Agent 对话能力不属于营养库领域本身。
...
- **用户故事 6**：作为内容创作者，我希望把 Agent 研究或缺口建议先保存为未沉淀营养卡片，以便于在不污染正式营养库的情况下快速试用资料。
  - **验收标准 (AC)**：未沉淀营养卡片归属于当前种子，可以作为本次枝化生长临时引用，但不会出现在正式可引用营养内容中。

- **用户故事 7**：作为内容创作者，我希望把确认有价值的营养卡片沉淀为种子专属营养内容，以便于后续稳定复用。
  - **验收标准 (AC)**：沉淀后卡片状态变为已沉淀，并关联一条当前种子专属营养内容。

- **用户故事 8**：作为内容创作者，我希望把高频有用的已沉淀卡片设置为常驻营养，以便于每次枝化生长默认带上它。
  - **验收标准 (AC)**：只有已沉淀卡片可以设置为常驻营养；前端默认带入但用户可以移除。
